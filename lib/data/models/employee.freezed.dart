...
class _$EmployeeImpl implements _Employee {
  ...
  @override
  String toString() {
    return 'Employee(id: $id, name: $name, position: $position, salary: $salary, morale: $morale, hiredAt: $hiredAt)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, id, name, position, salary, morale, hiredAt);
